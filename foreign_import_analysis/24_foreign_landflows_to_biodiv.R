...
foreign_vlt_export <- fread(file.path(final_output_path, 'foreign_VLT_by_country_x_TNC.csv'))

# Consumption-side VLT (USA county)
foreign_vlt_import <- fread(file.path(final_output_path, 'foreign_VLT_by_TNC_x_county.csv'))
...
fwrite(foreign_vlt_export_CF, file.path(final_output_path, 'foreign_species_lost_by_export_country_x_tnc.csv'))
...
fwrite(foreign_vlt_import_CF, file.path(final_output_path, 'foreign_species_lost_by_import_county.csv'))
