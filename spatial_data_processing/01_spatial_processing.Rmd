...
tncproj=`gdalsrsinfo ${data_path}/tnc_terr_ecoregions/tnc_terr_ecoregions.prj -o proj4 | xargs`

ogr2ogr -f "GPKG" -t_srs "${proj_moll}" -s_srs "${tncproj}" tnc_global_equalarea.gpkg ${data_path}/tnc_terr_ecoregions/tnc_terr_ecoregions.shp

# Transform global country boundaries to Mollweide
countryproj=`gdalsrsinfo ne_50m_admin_0_countries.prj -o proj4 | xargs`

ogr2ogr -f "GPKG" -t_srs "${proj_moll}" -s_srs "${countryproj}" countries_global_equalarea.gpkg ${data_path}/ne_50m_admin_0_countries/ne_50m_admin_0_countries.shp

# Transform both the cropland and pastureland raster layers to the Mollweide projection.

cd ${data_path}/global_cropland
...
county_tnc <- st_read(file.path(spatial_output_path, 'county_tnc_aea_intersect.gpkg'))
...
usaraster="~/data/NLCD_L48/nlcd2016landcover.vrt"
...
gdalsrsinfo -o wkt ${data_path}/NLCD_AK/NLCD_2016_Land_Cover_AK_20200724.img > ${data_path}/NLCD_AK/alaska_crs.wkt
gdalsrsinfo -o wkt ${data_path}/NLCD_HI/hi_landcover_wimperv_9-30-08_se5.img > ${data_path}/NLCD_HI/hawaii_crs.wkt

# Project to AK
ogr2ogr -f "GPKG" -t_srs ${data_path}/NLCD_AK/alaska_crs.wkt ${spatial_output_path}/county_tnc_intersect_alaska_crs.gpkg ${spatial_output_path}/county_tnc_aea_intersect.gpkg

# Project to HI
ogr2ogr -f "GPKG" -t_srs ${data_path}/NLCD_HI/hawaii_crs.wkt ${spatial_output_path}/county_tnc_intersect_hawaii_crs.gpkg ${spatial_output_path}/county_tnc_aea_intersect.gpkg
